...
export function mockFinancialData() {
  ...
  const quarterlyData = [
    { quarter: 'Q1', revenue: faker.number.int({ min: 400000, max: 600000 }), profit: faker.number.int({ min: 100000, max: 200000 }) },
    { quarter: 'Q2', revenue: faker.number.int({ min: 450000, max: 650000 }), profit: faker.number.int({ min: 120000, max: 220000 }) },
    { quarter: 'Q3', revenue: faker.number.int({ min: 420000, max: 620000 }), profit: faker.number.int({ min: 110000, max: 210000 }) },
    { quarter: 'Q4', revenue: faker.number.int({ min: 480000, max: 680000 }), profit: faker.number.int({ min: 130000, max: 230000 }) },
  ];

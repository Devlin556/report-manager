                ...
                >
                  <Select.Viewport className="p-1">
                    {reportTypes.map((t) => (
                      ...
                      >
                        <Select.ItemText>
                          {REPORT_NAMES[t.reportType] ?? t.reportType} ({t.format})
                        </Select.ItemText>
          ...
          <table className="w-full min-w-[500px] text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50">
                <th className="px-4 py-2 text-left font-medium text-gray-700">Тип</th>
                <th className="px-4 py-2 text-left font-medium text-gray-700">Формат</th>
                ...
                <th className="px-4 py-2 text-right font-medium text-gray-700">Действия</th>
              </tr>
            </thead>
            <tbody>
              {reports.length === 0 ? (
                ...
                reports.map((r) => (
                  <tr key={r.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="px-4 py-2 font-medium">{REPORT_NAMES[r.type] ?? r.type}</td>
                    <td className="px-4 py-2 text-gray-600">{r.format.toUpperCase()}</td>
